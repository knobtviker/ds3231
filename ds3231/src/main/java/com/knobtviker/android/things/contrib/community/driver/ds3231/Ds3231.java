...
public class Ds3231 implements Closeable {
    ...
    public static final int[] ALARM1_MATCH_DAY_OF_MONTH_HOURS_MINUTES_SECONDS = {0b0000_0000, 0b0000_0000, 0b0000_0000, 0b0000_0000};
    public static final int[] ALARM1_MATCH_DAY_OF_WEEK_HOURS_MINUTES_SECONDS = {0b0000_0000, 0b0000_0000, 0b0000_0000, 0b0100_0000};
    ...
    @IntDef({FREQUENCY_1_HZ, FREQUENCY_1024_HZ, FREQUENCY_4096_HZ, FREQUENCY_8192_HZ})
    public @interface SquareWaveOutputFrequency {
    }

    public static final int FREQUENCY_1_HZ = 0b0000_0000;
    public static final int FREQUENCY_1024_HZ = 0b0000_1000;
    public static final int FREQUENCY_4096_HZ = 0b0001_0000;
    public static final int FREQUENCY_8192_HZ = 0b0001_1000;


    private static final int TIMEKEEPING_INVALID = -1;
    ...
    public Ds3231(String i2cName, int i2cAddress) throws IOException {
        final I2cDevice device = PeripheralManager.getInstance().openI2cDevice(i2cName, i2cAddress);
        try {
            connect(device);
    ...
    public Date getTime() throws IOException {
        if (isTimekeepingDataValid()) {
            ...
            final int second = packetBcdToDec(buffer[0]);
            final int minute = packetBcdToDec(buffer[1]);
            final int hour = getHourFromBcd(buffer[2]);
            final int day = packetBcdToDec(buffer[4]);
            final int month = packetBcdToDec((byte) (buffer[5] & 0b0001_1111)) - 1;
            final int century = ((buffer[5] & 0xFF) & RTC_MONTH_REG_CENTURY) == RTC_MONTH_REG_CENTURY ? 2000 : 1900;
            final int year = century + packetBcdToDec(buffer[6]);

            final Calendar calendar = Calendar.getInstance(TimeZone.getTimeZone(ZoneOffset.UTC));
     ...
     * @throws IOException
     */
    public void setTime(final long timeInMillis) throws IOException {
    ...
    public boolean isTimekeepingDataValid() throws IOException {
        return ((readRegByte(RTC_STATUS_REG) & 0xFF) & RTC_STATUS_REG_OSCILLATOR_STOP_FLAG) != RTC_STATUS_REG_OSCILLATOR_STOP_FLAG;
    }
    ...
    public boolean isOscillatorEnabled() throws IOException {
        return ((readRegByte(RTC_CONTROL_REG) & 0xFF) & RTC_CONTROL_REG_DISABLE_OSCILLATOR) != RTC_CONTROL_REG_DISABLE_OSCILLATOR;
    }
    ...
    public boolean is32khz() throws IOException {
        return ((readRegByte(RTC_STATUS_REG) & 0xFF) & RTC_STATUS_REG_ENABLE_32KHZ_OUTPUT) == RTC_STATUS_REG_ENABLE_32KHZ_OUTPUT;
    }
     ...
     * @throws IOException
     */
    public void set32khz(final boolean enabled) throws IOException {
        byte reg = readRegByte(RTC_STATUS_REG);
    ...
    public boolean isSquareWaveEnabled() throws IOException {
        return ((readRegByte(RTC_CONTROL_REG) & 0xFF) & RTC_CONTROL_REG_BATTERY_BACKED_SQUARE_WAVE_ENABLE) == RTC_CONTROL_REG_BATTERY_BACKED_SQUARE_WAVE_ENABLE;
    }
     ...
     * @throws IOException
     */
    public void setSquareWave(final boolean enabled) throws IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
     ...
     * @throws IOException
     */
    public void setSquareWaveOutputFrequency(@SquareWaveOutputFrequency int squareWaveOutputFrequency) throws IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
    ...
    public boolean isTemperatureRefreshing() throws IOException {
        final int controlReg = readRegByte(RTC_CONTROL_REG) & 0xFF;
        final int statusReg = readRegByte(RTC_STATUS_REG) & 0xFF;
    ...
    public float readTemperature() throws IOException {
        final boolean alreadyBusy = ((readRegByte(RTC_STATUS_REG) & 0xFF) & RTC_STATUS_REG_BUSY) == RTC_STATUS_REG_BUSY;
        if (!alreadyBusy) {
    ...
    public boolean isInterruptControlEnable() throws IOException {
        return ((readRegByte(RTC_CONTROL_REG) & 0xFF) & RTC_CONTROL_REG_INTERRUPT_CONTROL) == RTC_CONTROL_REG_INTERRUPT_CONTROL;
    }
     ...
     * @throws IOException
     */
    public void setInterruptControl(final boolean enabled) throws IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
    ...
    public boolean isAlarm1InterruptEnable() throws IOException {
        return ((readRegByte(RTC_CONTROL_REG) & 0xFF) & RTC_CONTROL_REG_ALARM1_INTERRUPT_ENABLE) == RTC_CONTROL_REG_ALARM1_INTERRUPT_ENABLE;
    }
     ...
     * @throws IOException
     */
    public void setAlarm1Interrupt(final boolean enabled) throws IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
    ...
    public Alarm1 getAlarm1() throws IOException {
        ...
        final int[] alarmRate = getAlarmRate(buffer, ALARM1_RATES, ALARM1_MASK_BITS);
        ...
        final int minute = packetBcdToDec(buffer[1]);
        final int hour = getHourFromBcd(buffer[2]);
        final int day = packetBcdToDec(buffer[3]);
     ...
     * @throws IOException
     */
    public void setAlarm1(@NonNull final Alarm1 alarm) throws IOException {
        final byte[] buffer = new byte[4];
    ...
    public boolean isAlarm2InterruptEnable() throws IOException {
        return ((readRegByte(RTC_CONTROL_REG) & 0xFF) & RTC_CONTROL_REG_ALARM2_INTERRUPT_ENABLE) == RTC_CONTROL_REG_ALARM2_INTERRUPT_ENABLE;
    }

    public void setAlarm2Interrupt(final boolean enabled) throws IOException {
        byte reg = readRegByte(RTC_CONTROL_REG);
    ...
    public Alarm2 getAlarm2() throws IOException {
        ...
        final int[] alarmRate = getAlarmRate(buffer, ALARM2_RATES, ALARM2_MASK_BITS);

        clearAlarmMaskBits(buffer, ALARM2_MASK_BITS);

        final int minute = packetBcdToDec(buffer[0]);
        final int hour = getHourFromBcd(buffer[1]);
        final int day = packetBcdToDec(buffer[2]);
     ...
     * @throws IOException
     */
    public void setAlarm2(@NonNull final Alarm2 alarm) throws IOException {
        final byte[] buffer = new byte[3];
    ...
    private int[] getAlarmRate(final byte[] buffer, final int[][] alarmRates, final int[] alarmMaskBits) {
        ...
        final int[] currentAlarmRate = new int[buffer.length];
    ...
    private void clearAlarmMaskBits(final byte[] buffer, final int[] alarmMaskBits) {
        if (buffer.length != alarmMaskBits.length) {
            throw new IllegalArgumentException("buffer length and alarmMaskBits length are different");
        }
     ...
     * @throws IOException
     */
    public void setAgingOffset(final byte agingOffset) throws IOException {
     ...
     * @throws IOException
     */
    private byte readRegByte(final int reg) throws IOException {
        if (mI2cDevice == null) {
     ...
     * @throws IOException
     */
    private void readRegBuffer(final int reg, final byte[] buffer, final int length) throws IOException {
        if (mI2cDevice == null) {
            throw new IllegalStateException("I2C device not open");
        }
     ...
     * @throws IOException
     */
    private void writeRegByte(final int reg, final byte data) throws IOException {
        if (mI2cDevice == null) {
            throw new IllegalStateException("I2C device not open");
        }
     ...
     * @throws IOException
     */
    private void writeRegBuffer(final int reg, final byte[] buffer, final int length) throws IOException {
        if (mI2cDevice == null) {
            throw new IllegalStateException("I2C device not open");
        }
    ...
    private int getHourFromBcd(final byte bcd) {
        int hour;
    ...
    private int packetBcdToDec(final byte bcd) {
        return (((bcd & 0xFF) >> 4) * 10) + (bcd & 0xF);
    }

    private byte decToPacketBcd(final int dec) {
        if (dec < 0 || dec > 99) {
